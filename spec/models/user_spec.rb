...
RSpec.describe User, type: :model do
  ...
  describe "#favorite_for(post)" do
    ...
    it "returns `nil` if the user has not favorited the post" do
      expect(some_other_user.favorite_for(@post)).to be_nil
    end

    it "returns the appropriate favorite if it exists" do
      favorite = some_other_user.favorites.where(post: @post).create
      expect(some_other_user.favorite_for(@post)).to eq(favorite)
    end
  end
